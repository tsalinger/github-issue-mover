...
(function () {
    ...
    function start() {
        location.href.indexOf(decodeURI(BODY_UNIQUE_SIGN)) !== -1
    ...
    async function collect(): Promise<void> {
        ...
        try {
            ...
            const finalURL = issueURL + `new?title=${encodeURIComponent(mainComment.subject)}&body=${BODY_UNIQUE_SIGN}`;
